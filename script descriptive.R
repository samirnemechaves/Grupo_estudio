...
#un marco de datos con un formato agradable. lo que nos permitiria graficarlo posteriormente
...
#Primero, tenemos que asociar los datos agregados a regiones específicas del mapa usando los códigos de país.
#joinCountryData2Map (), hace coincidir las ubicaciones de los países (store.df $ country) para los puntos de datos 
#con los nombres estándar internacionales correspondientes (nombres ISO)
